...
const pluginName = 'google-analytics-baby';
const dataDir = process.env.GA_BABY_DATA && !process.env.GA_BABY_DATA.includes('${')
  ? process.env.GA_BABY_DATA
  : join(homedir(), '.google-analytics-baby');
