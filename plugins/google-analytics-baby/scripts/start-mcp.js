...
const dataDir = process.env.GA_BABY_DATA || join(homedir(), '.google-analytics-baby');
...
async function autoUpdate() {
  try {
    ...
    process.stderr.write(`Updating google-analytics-baby ${localVersion()} -> ${remote.version}...\n`);
    ...
    process.stderr.write(`Could not update google-analytics-baby: ${error.message}\n`);
  }
}
